...
public class WebServer {
  ...
  //public static final String FAKEGAME = "/FAKEGAME";
  public static final String GAME = "/game";
  public static final String RESIGN = "/resignGame";
  public static final String VALIDATE = "/validateMove";
  public static final String SUBMIT = "/submitTurn";
  public static final String CHECK = "/checkTurn";
  public static final String BACKUP = "/backupMove";
  public static final String SPECTATEGAME = "/spectator/game";
  public static final String STOPSPECTATE = "/spectator/stopWatching";
  public static final String SPECTATECHECK = "/spectator/checkTurn";
  ...
  public void initialize() {
    ...
    get(GAME, new GetGameRoute(templateEngine, playerlobby));

    get(SPECTATEGAME, new GetSpectatorBegin(templateEngine, playerlobby));

    get(STOPSPECTATE, new GetSpectatorExit(templateEngine, playerlobby));

    post(RESIGN, new PostResignGameRoute(templateEngine, playerlobby, gson));

    post(CHECK, new PostCheckTurnRoute(templateEngine, playerlobby, gson));

    post(VALIDATE, new PostValidateMoveRoute(templateEngine, playerlobby, gson));

    post(SUBMIT, new PostSubmitTurnRoute(templateEngine, playerlobby, gson));

    post(BACKUP, new PostBackUpMoveRoute(templateEngine, playerlobby, gson));

    post(SPECTATECHECK, new PostSpectatorCheckTurn(templateEngine, playerlobby, gson));
//
//
    //post(RESIGN, .....)
